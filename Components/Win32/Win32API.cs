...
/* AdminCon 7.0 Command Line Interface Edition - Source Code - Win32API.cs
...
namespace AdminCon_CLI_dotnetEdition.Components.Win32
{
    ...
    public class Win32API
    {
        ...
        [DllImport("User32.dll", CharSet = CharSet.Auto)]
        public static extern IntPtr BeginPaInt32(IntPtr hWnd, ref PAINTSTRUCT ps);
        [DllImport("User32.dll", CharSet = CharSet.Auto)]
        public static extern Boolean EndPaInt32(IntPtr hWnd, ref PAINTSTRUCT ps);
        [DllImport("User32.dll", CharSet = CharSet.Auto)]
        ...
        [DllImport("User32.dll", CharSet = CharSet.Auto)]
        public static extern Boolean MoveWindow(IntPtr hWnd, Int32 x, Int32 y, Int32 width, Int32 height, Boolean repaInt32);
        [DllImport("User32.dll", CharSet = CharSet.Auto)]
        ...
        public static extern Int32 ToAscii(Int32 uVirtKey,       // [in]     Specifies the virtual-key code to be translated.
                                         ...
                                         Byte[] lpbKeyState, // [in]     PoInt32er to a 256-Byte array that contains the current keyboard state. Each element (Byte) in the array contains the state of one key. If the high-order bit of a Byte is set, the key is down (pressed). The low bit, if set, indicates that the key is toggled on. In this function, only the toggle bit of the CAPS LOCK key is relevant. The toggle state of the NUM LOCK and SCROLL LOCK keys is ignored.
                                         Byte[] lpwTransKey, // [out]    PoInt32er to the buffer that receives the translated Character or Characters.
        ...
        public static Point GetPoInt32FromLPARAM(Int32 lParam)
        {
